...
<div className="boarder-1-4 boarder-[#C85A1A] bg-[#F5F5F5] p-8">
  ...
  <p className="leading-7 text-[#6B7280]">To become Africa&apos;s leading Earth observation and health analytics consortium driving resilient, data-driven healthcare systems and environmental intelligence across the continent</p>
      ...
      <section className="bg-gray-50 px-6 py-16">
        <div className="mx-auto max-w-7xl">
          <h2 className="mb-10 text-black text-center text-3xl font-bold">Our Focus Areas</h2>
          <div className= "grid gap-6 md:grid-cols-3">

            {/*Disease Surveillance*/}
            <div className="rounded-lg bg-white p-8 shadow-sm">
              <div className="mb-4 text-3xl ">🦠</div>
              <h3 className="mb-4 text-3xl font-semibold text-[#2C2C2C]">Disease Surveillance</h3>
            ...
            <div className="rounded-lg bg-white p-8 shadow-sm">
              <div className="mb-4 text-3xl">🌍</div>
              <h3 className="mb-4 text-3xl font-semibold text-[#2C2C2C]">Climate and Health</h3>
            ...
            <div className="rounded-lg bg-white p-8 shadow-sm">
              <div className="mb-4 text-3xl">📡</div>
              <h3 className="mb-4 text-3xl font-semibold text-[#2C2C2C]">Remote Sensing</h3>
            ...
            <div className="rounded-lg bg-white p-8 shadow-sm">
              <div className="mb-4 text-3xl">📈</div>
              <h3 className="mb-4 text-3xl font-semibold text-[#2C2C2C]">Health Intelligence & Analytics</h3>
            ...
            <div className="rounded-lg bg-white p-8 shadow-sm">
              <div className="mb-4 text-3xl">🔍</div>
              <h3 className="mb-4 text-3xl font-semibold text-[#2C2C2C]">Healthcare Research & Consulting</h3>
            ...
            <div className="rounded-lg bg-white p-8 shadow-sm">
              <div className="mb-4 text-3xl">👩‍💻</div>
              <h3 className="mb-4 text-3xl font-semibold text-[#2C2C2C]">Technical Services</h3>
            ...
            <div className="rounded-lg bg-white p-8 shadow-sm">
              <div className="mb-4 text-3xl">📑</div>
              <h3 className="mb-4 text-3xl font-semibold text-[#2C2C2C]">Capacity Building & Project Delivery</h3>
            ...
            <div className="rounded-lg bg-white p-8 shadow-sm">
              <div className="mb-4 text-3xl">🔭</div>
              <h3 className="mb-4 text-3xl font-semibold text-[#2C2C2C]">Earth Observational climate change mitigation and adaptation</h3>
